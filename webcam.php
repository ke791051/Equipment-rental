...
<p>&nbsp; </p>
   ...
   <form name="form1" method="POST" action="process_finish.php">
     ...
     <table width="905" height="300" border="0">
           <tr>
    <th width="261" height="315" scope="row"><img src="PRO 9000.jpg" width="200" height="150" alt="pro9000" /><br />
      PRO 9000<br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$query = sprintf("SELECT * FROM indata where model = 'PRO 9000' AND NY = '$null'");
$result = mysql_query($query)or die(mysql_error());
