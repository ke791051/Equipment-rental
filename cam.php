...
<p>&nbsp; </p>
   ...
   <form name="form1" method="POST" action="process_finish.php">
      ...
      <table width="905" height="600" border="0">
           <tr>
   <th width="261" height="315" scope="row"><img src="SONY-a33.JPG" width="200" height="150" alt="SONY-a33" /><br />SONY-a33 
        <br>
        <br>
        <select name="number" onchange= "choose(this);">
          ...
          <?php
$_SESSION["name"] = "數位照相機";
$_SESSION["model"] = "SONY-a33";	 
$query = sprintf("SELECT * FROM indata where model = 'SONY-a33' AND NY = '$null'");
$result = mysqli_query($db, $query)or die(mysqli_error());
...
?>   
    ...
    <form name="form1" method="POST" action="process_finish.php">
     <th width="262" scope="row"><img src="SONY-DSC-W200.jpg" width="200" height="150" alt="SONY-DSC-W200" /><br />SONY-DSC-W200
    <br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$_SESSION["name"] = "數位照相機";
$_SESSION["model"] = "SONY-DSC-W200";	
$query = sprintf("SELECT * FROM indata where model = 'SONY-DSC-W200' AND NY = '$null'");
$result = mysqli_query($db, $query)or die(mysqli_error());
$number = mysqli_num_rows($result);
...
?>   </select>
 <input type="submit" name="Submit" value=" 申請 " />
      ...
      <form name="form1" method="POST" action="process_finish.php">
    <th width="261" scope="row"><img src="SONY-NEX-5.jpg" width="200" height="150" alt="SONY-NEX5" /><br />SONY-NEX-5
     <br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$_SESSION["name"] = "數位照相機";
$_SESSION["model"] = "SONY-NEX-5";	
$query = sprintf("SELECT * FROM indata where model = 'SONY-NEX5' AND NY = '$null' ");
$result = mysqli_query($db, $query)or die(mysqli_error());
$number = mysqli_num_rows($result);
...
?>   </select>
 <input type="submit" name="Submit" value=" 申請 " />
    ...
    <form name="form1" method="POST" action="process_finish.php">
    <tr>
    <th  height="288" scope="row"><img src="Olympus-700.jpg" width="200" height="150" alt="Olympus-700" /><br />Olympus-700
 <br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$_SESSION["name"] = "數位照相機";
$_SESSION["model"] = "Olympus-700";	
$query = sprintf("SELECT * FROM indata where model = 'Olympus-700' AND NY = '$null' ");
$result = mysqli_query($db, $query)or die(mysqli_error());
$number = mysqli_num_rows($result);
