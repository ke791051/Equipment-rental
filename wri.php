...
<p>&nbsp; </p>
   ...
   <form name="form1" method="POST" action="process_finish.php">
      ...
      <table width="806" height="300" border="0">
           <tr>
    <th width="261" height="315" scope="row"><img src="D8-U Mifare.jpg" width="250" height="150" alt="D8-U" /><br />
      D8-U Mifare<br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$query = sprintf("SELECT * FROM indata where model = 'D8-U Mifare' AND NY = '$null'");
$result = mysqli_query($db, $query)or die(mysqli_error());
