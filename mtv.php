...
<p>&nbsp; </p>
   ...
   <form name="form1" method="POST" action="process_finish.php">
     ...
     <table width="905" height="300" border="0">
           <tr>
    <th width="261" height="315" scope="row"><img src="Aria.jpg" width="150" height="200" alt="Aria" /><br />
      Aria-3.2吋<br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$query = sprintf("SELECT * FROM indata where model = 'Aria-3.2' AND NY = '$null'");
$result = mysql_query($query)or die(mysql_error());
...
?>   </select>
   ...
   <input type="submit" name="Submit" value=" 申請 " />
     ...
     <form name="form1" method="post" action="process_finish.php">
    <th width="262" scope="row"><img src="Desire.jpg" width="150" height="200" alt="Desire 3.7" /><br />
      Desire-3.7吋<br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$query = sprintf("SELECT * FROM indata where model = 'Desire-3.7' AND NY = '$null'");
$result = mysql_query($query)or die(mysql_error());
$number = mysql_num_rows($result);
