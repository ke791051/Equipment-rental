...
<p>&nbsp; </p>
   ...
   <form name="form1" method="POST" action="process_finish.php">
      ...
      <table width="905" height="300" border="0">
           <tr>
    <th width="261" height="315" scope="row"><img src="INTUOS-6x8.jpg" width="200" height="150" alt="INTUOS-6x8" /><br />INTUOS-6x8專業數位板
    ...
    <option value="">請選擇編號</option> 
     <?php
$query = sprintf("SELECT * FROM indata where model = 'INTUOS-6x8專業數位板' AND NY = '$null' ");
$result = mysqli_query($db, $query)or die(mysqli_error());
