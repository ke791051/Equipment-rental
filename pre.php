...
<p>&nbsp; </p>
   ...
   <form name="form1" method="POST" action="process_finish.php">
       ...
       <table width="905" height="300" border="0">
           <tr>
    <th width="261" height="315" scope="row"><img src="HAWK 4in1-ZOOM.jpg" width="190" height="200" alt="HAWK 4in1-ZOOM" /><br />
      HAWK 4in1-ZOOM<br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$query = sprintf("SELECT * FROM indata where model = 'HAWK 4in1-ZOOM' AND NY = '$null'");
$result = mysqli_query($db, $query)or die(mysqli_error());
