...
<p>&nbsp; </p>
 ...
 <table width="905" height="300" border="0">
           <tr>
    <th width="261" height="315" scope="row"><img src="SONY-DCR-SR300.jpg" width="200" height="150" alt="SONY-SR300" /><br />SONY-DCR-SR300
    <br>
    <br>
...
?>   </select>
   ...
   <form name="form1" method="post" action="process_finish.php">
    <th width="262" scope="row"><img src="HDC-HS60GT.jpg" width="200" height="150" alt="HDC-HS60GT" /><br />Panasonic-HDC-HS60GT
    <br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
