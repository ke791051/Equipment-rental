...
<p>&nbsp; </p>
   ...
   <form name="form1" method="POST" action="process_finish.php">
      ...
      <table width="905" height="300" border="0">
           <tr>
    <th width="261" height="315" scope="row"><img src="Focus-500.jpg" width="150" height="200" alt="Focus-500" /><br />
      Focus-500<br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$query = sprintf("SELECT * FROM indata where model = 'Focus-500' AND NY = '$null'");
$result = mysql_query($query)or die(mysql_error());
...
?>   </select>
   ...
   <input type="submit" name="Submit" value=" 申請 " />
    ...
    <form name="form1" method="post" action="process_finish.php">
    <th width="262" scope="row"><img src="Smart-300.jpg" width="250" height="200" alt="Smart-300" /><br />
      Smart-300<br>
    <br>
     <select name="number" onchange= "choose(this);">
    <option value="">請選擇編號</option> 
     <?php
$query = sprintf("SELECT * FROM indata where model = 'Smart-300' AND NY = '$null'");
$result = mysql_query($query)or die(mysql_error());
$number = mysql_num_rows($result);
